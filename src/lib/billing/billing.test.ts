...
nock(config.billingAPI)
  ...
  .get('/billable_events?range_start=2018-01-01&range_stop=2018-01-02&org_guid=org-guid-500').reply(500, `{"message":"NOT OK"}`)
  .get('/billable_events?range_start=2018-01-01&range_stop=2018-01-02&org_guid=org-guid-bad-price').reply(200, `[{
    "price": {
      "ex_vat": "not-a-number",
      "inc_vat": "1.0",
      "details": []
  ...
  .get('/billable_events?range_start=2018-01-01&range_stop=2018-01-02&org_guid=3deb9f04-b449-4f94-b3dd-c73cefe5b275').reply(200, `[{
